...
This server is based on code from the **[Udacity Readable Project Server](https://github.com/udacity/reactnd-project-readable-starter)**

It can be run locally or you can use the hosted version at https://chit-chat-server.herokuapp.com/

## Running the server locally

To install and start the API server locally, run the following commands in this directory:
